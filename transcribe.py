...
def convert_to_voice():
    # the model of TTS
    key = 'Wi9BIgVxpAnpyBBL2hBDbrCuLilOlci7bpacVWpP4Ej7'
    url = ' https://api.us-east.speech-to-text.watson.cloud.ibm.com/instances/d9e7e685-17c6-418c-89d9-c01f9b00573f'
    ...
    # output as mp3 file
    with open('./AUDIO_2.mp3', 'wb') as audio_file:
        res = tts.synthesize(text, accept='AUDIO_2/mp3', voice='en-us_JamesV3Voice').get_result()
